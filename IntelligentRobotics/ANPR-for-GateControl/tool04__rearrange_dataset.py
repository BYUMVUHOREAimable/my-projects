...
Run a qick command to check that every image has a corresponding label file:

for img in yolov5/dataset1/images/*/*.jpg; do [ -f yolov5/dataset1/labels/train/$(basename "${img%.jpg}.txt")" ] || echo "Missing label for $img"; done
"""