  ...
  return (
    <div className='flex p-[20px] md:px-20 justify-between flex-col md:flex-row'>
        ...
        <div className='flex w-full flex-col items-start content-end'>
          ...
          <div>
            <h1 className='my-5 text-gray-400'>
              I am BYUMVUHORE Aimable and I worked as Developer and currently I am a Software Architecture
            </h1>
          </div>
          <button className="hover:z-50 transition-all duration-300 ease-in-out hover:scale-125 bg-purple-600 p-2 rounded-md text-white">
            <a
              href={require('./../assets/BAIResume.pdf')}
              download="BAIResume.pdf"
      ...
      <div className='w-full flex justify-center'>
        <img src={homeImage} className="w-[200px] md:w-[300px]" alt='homeImage' />
      </div>
    </div>
  );
};
